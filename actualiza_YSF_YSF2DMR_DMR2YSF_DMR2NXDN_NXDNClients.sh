...
MARRON="\33[38;5;138m"
                        ...
                        #sudo sed -i '209c std::string name = "IMAGEN ADER B108";' YSFGateway.cpp # para que salga en el dashboard en REPEATER EN Name lo que se escriba en editar YSF & FCS en el item 7) Name       
                        sudo sed -i '28c const char* YSF_VERSION = "ADER B108";' YSFNetwork.cpp # Se ha de crear esta linea nueva SALE EN EL DSAHBOARD EN SERVICES Y Device
