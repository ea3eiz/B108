...
sed -i "4c Exec=sh -c 'cd /home/pi/$SCRIPTS_version;xterm -geometry 88x17+648+664 -bg black -fg white -fa 'Verdana' -fs 9x -T SOLO_DSTAR -e sudo sh OpenEjecutarRadio.sh'" /home/pi/Abrir_Radio.desktop
