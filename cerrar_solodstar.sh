...
sed -i "6c Exec=sh -c 'cd /home/pi/B108/;xterm -geometry 88x17+1272+664 -bg black -fg white -fa 'Verdana' -fs 9x -T MMDVMSOLODSTAR -e sudo sh OpenEjecutarSolodstar.sh'" /home/pi/Abrir_solodstar.desktop
