...
cd /home/pi/Desktop
sudo cp Abrir_MMDVMPLUS.desktop /home/pi
sudo sed -i "4c Exec=sh -c 'cd /home/pi/$SCRIPTS_version;xterm -geometry 76x15+1296+560 -bg black -fg white -fa 'Serif' -fs 9x -T DMRPLUS -e sudo sh sudo ejecutar_DMRPLUS.sh'" /home/pi/Abrir_MMDVMPLUS.desktop
