...
#zenity --info --ok-label= --title=Abriendo_BlueDB --window-icon=/home/pi/B108/ICONO_BLUEDV_ON.png --width=400 --timeout=125 --text "El BlueDv tardará unos minutos en abrirse \ndependiendo de la velocidad de su Raspberry\nsea paciente y espere que se abra."

cd /home/pi/bluedv/
/home/pi/B108/./qt_aviso_abriendo_bluedv | mono BlueDV.exe
